...
// Jika ID Kategori tidak valid, redirect ke halaman utama atau tampilkan pesan error
if ($id_kategori <= 0) {
...
$kategoriSql = "SELECT nama_kategori FROM kategori WHERE id_kategori = $id_kategori";
$kategoriResult = $conn->query($kategoriSql);
$nama_kategori = $kategoriResult->fetch_assoc()['nama_kategori'] ?? 'Unknown Category';

// Query untuk mengambil semua kategori (untuk menu atau navigasi)
$categories = [];
...
// Query untuk mengambil artikel berdasarkan kategori yang dipilih
  ...
  <main id="main">
    ...
    <div class="row">
        <div class="col-md-9" data-aos="fade-up">
            <h3 class="category-title">Category: <?php echo htmlspecialchars($nama_kategori); ?></h3>
        ...
        <div class="row g-5">
          ...
          <div class="col-6 col-lg-2">
            ...
            <ul class="footer-links list-unstyled">
              ...
              <li><p></p><i class="bi bi-chevron-right"></i> Categories</p></li>
