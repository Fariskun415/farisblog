        ...
        <div id="layoutSidenav_content">
            <main>
                <div class="container-fluid px-4">
                    ...
                    <br>
                    <button type="button" class="btn btn-primary mb-4" data-bs-toggle="modal" data-bs-target="#tambah">Tambah Artikel</button>
                    <br>
                    <br>
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            <table id="datatablesSimple">
                                ...
                                $query = mysqli_query($conn, "SELECT artikel.*, kategori.nama_kategori FROM artikel JOIN kategori ON artikel.id_kategori = kategori.id_kategori ORDER BY artikel.id_artikel DESC");
                                                ...
                                                <form action="act_article.php" method="POST" enctype="multipart/form-data">
                                                    ...
                                                    <div class="modal-body">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <textarea class="form-control ckeditor" id="isi<?= $no ?>" name="isi" rows="5" required><?= $row['isi'] ?></textarea>
                                                        </div>
                                                        <div class="form-group">
                                                        ...
                                                        <div class="modal-footer">
                                                            ...
                                                            <button class="btn btn-primary" type="submit" name="articleedit">Submit</button>
                                                        </div>
                                                    </div>
                                                </form>
                                            </div>
                                        ...
                                        <div class="modal-dialog modal-lg">
                                            <div class="modal-content">
                                                ...
                                                <form action="act_article.php" method="POST">
                                                    ...
                                                    <div class="modal-body">
                                                        <div class="modal-footer">
                                                            <h5 class="text-center">Are you sure you want to delete this article? <br><span class="text-danger"><?= $row['judul'] ?></span></h5>
                                                            <button type="button" class="btn btn-danger" data-bs-dismiss="modal">Close</button>
                            ...
                            <form action="act_article.php" method="POST" enctype="multipart/form-data">
                                <div class="modal-body">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="penulis" placeholder="Masukan Nama Panulis" required>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <label class="control-label" for="isi">Isi</label>
                                        <textarea class="form-control ckeditor" id="isiTambah" name="isi" rows="5" placeholder="Tulis isi" required></textarea>
                                    </div>
                                    <div class="form-group">
                                        <label class="control-label" for="gambar">Gambar</label>
                                    ...
                                    <div class="modal-footer">
                                        <button type="button" class="btn btn-danger" data-bs-dismiss="modal">Close</button>
                                        <button class="btn btn-primary" type="submit" name="articlesave">Tambah Artikel</button>
                                    </div>
                                </div>
                            </form>
                        </div>
